...
export const getUserOrders = () => {
  return (dispatch) => {
    ...
    const url = `https://reactdeploy-heroku.herokuapp.com/order/user`
...
export const makeOrder = () => {
  ...
  return (dispatch) => {
    ...
    const url = `https://reactdeploy-heroku.herokuapp.com/order/process`
    axios
...
export const deleteCartItem = (id) => {
  return (dispatch) => {
    ...
    const url = `https://reactdeploy-heroku.herokuapp.com/cart/${id}`
...
export const getCartList = () => {
  return (dispatch) => {
    ...
    const url = `https://reactdeploy-heroku.herokuapp.com/cart`
...
export const getProductList = (subCategoryId) => {
  return (dispatch) => {
    ...
    const url = `https://reactdeploy-heroku.herokuapp.com/product/category/${subCategoryId}`
...
export const getproducts = () => {
  return (dispatch) => {
    ...
    const url = `https://reactdeploy-heroku.herokuapp.com/product`
    axios
      .get(url, header)
      .then((response) => {
        dispatch({
...
export const signup = (firstName, lastName, email, password,address,mobile) => {
  return (dispatch) => {
    ...
    const url = `https://reactdeploy-heroku.herokuapp.com/user/signup`
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
...
export const signin = (email, password) => {
  return (dispatch) => {
    ...
    const url = `https://reactdeploy-heroku.herokuapp.com/user/signin`
    axios
      .post(url, body, header)
      .then((response) => {
        dispatch({
