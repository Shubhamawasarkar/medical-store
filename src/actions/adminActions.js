import {
  ...
  export const  deliverOrder = (id) => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/order-details/${id}`
      axios
        .put(url, header)
        .then((response) => {
          dispatch({
  ...
  export const  getDispatchedorders = () => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/order-details`
      axios
        .get(url, header)
        .then((response) => {
          dispatch({
  ...
  export const  approveOrder = (id) => {
    return (dispatch) => {
      ...
      const url =`https://reactdeploy-heroku.herokuapp.com/order/approve/${id}`
      axios
        .put(url,header)
        .then((response) => {
          dispatch({
  ...
  export const  getorders = () => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/order`
      axios
        .get(url, header)
        .then((response) => {
          dispatch({
  ...
  export const addAdmin = (firstName, lastName, email, password,address,mobile) => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/user/add-admin`
      axios
  ...
  export const deleteAdmin = (id) => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/user/${id}`
  ...
  export const  getAdmins = () => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/admin`
      axios
        .get(url, header)
        .then((response) => {
          dispatch({
  ...
  export const  getCustomers = () => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/user`
      axios
        .get(url, header)
        .then((response) => {
          dispatch({
  ...
  export const getSubCategory = (id) => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/sub-category/edit/${id}`
  ...
  export const updateSubCategory = (id,name,category_id) => {
    return (dispatch) => {
      ...
      const url =`https://reactdeploy-heroku.herokuapp.com/sub-category/${id}`
...
export const deleteSubCategory = (id) => {
  ...
  export const  getsubcategories = () => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/sub-category`
      axios
        .get(url, header)
        .then((response) => {
          dispatch({
...
export const deleteProduct = (productId) => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/product/${productId}`
  ...
  export const updateProduct = (id,name, description, price, company, sub_category) => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/product/${id}`
  ...
  export const addCategory = (name) => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/category`
  ...
  export const deleteCategory = (categoryId) => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/category/${categoryId}`
  ...
  export const updateCategory = (id,name) => {
    return (dispatch) => {
      ...
      const url = `https://reactdeploy-heroku.herokuapp.com/category/${id}`
